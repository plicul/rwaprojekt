...
<asp:Content ID="Content1" ContentPlaceHolderID="content1placeholder" runat="server">
    ...
    <table>
        <tr>
            <td><asp:Label ID="LabelAddCategory" runat="server">Kategorija:</asp:Label></td>
            <td>
        ...
        <tr>
            <td><asp:Label ID="LabelAddName" runat="server">Ime:</asp:Label></td>
            <td>
        ...
        <tr>
            <td><asp:Label ID="LabelAddPrice" runat="server">Cijena:</asp:Label></td>
            <td>
    ...
    <p></p>
    <p></p>
    <asp:Button ID="AddProductButton" runat="server" Text="Dodaj" OnClick="AddProductButton_Click"  CausesValidation="true"/>
    <asp:Label ID="LabelAddStatus" runat="server" Text=""></asp:Label>
    <p></p>
    <h3>Ukloni artikal:</h3>
    <table>
        <tr>
            <td><asp:Label ID="LabelRemoveProduct" runat="server">Artikal:</asp:Label></td>
    ...
    <p></p>
    <asp:Button ID="RemoveProductButton" runat="server" Text="Ukloni" OnClick="RemoveProductButton_Click" CausesValidation="false"/>
